...
class Werwolf(WerwolfTeam):
	def __init__(self, isAlive=True):
		...
		self.descriptions = {
			...
			gemeinschaftlich ein Opfer aus, dass sie diese Nacht reißen wollen. Die Werwölfe gewinnen, \
			falls alle Dorfbewohner gestorben sind.""",
			...
			Dorfbewohnern sucht, um dieses dann gemeinsam mit den anderen Werwölfen anzugreifen.""",
